...
EXTERNAL_ROUTINE void KFAST_AssRes(double *t, int* isInitialTime, int *numRtSpdRtrElem, double RtSpd_PyRtr[], double WindPt[], double FusO_prev[], double FusO[], double FusODCM_prev[], double FusOv_prev[],
...
EXTERNAL_ROUTINE void KFAST_Output(double *t, int *errStat, char errMsg[]);
