...
EXTERNAL_ROUTINE void KFAST_AssRes(double *t, int* doUpdateStates, int *numRtSpdRtrElem, double RtSpd_PyRtr[], double WindPt[], double FusO_prev[], double FusO[], double FusODCM_prev[], double FusOv_prev[],
