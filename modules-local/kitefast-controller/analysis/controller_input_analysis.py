...
print "running contorller input analysis"
...
#	k += 1
plt.figure(0)
plt.title('Xg.x vs Xg.y')
plt.plot(plot_vals[:,1],plot_vals[:,2],'-')
plt.axis([ np.min(plot_vals[:,1]), np.max(plot_vals[:,1]), np.min(plot_vals[:,2]), np.max(plot_vals[:,2]) ])
plt.show(block=True)

plt.figure(1)
plt.title('Xg.y vs Xg.z')
plt.plot(plot_vals[:,2],plot_vals[:,3],'-')
plt.axis([ np.min(plot_vals[:,2]), np.max(plot_vals[:,2]), np.min(plot_vals[:,3]), np.max(plot_vals[:,3]) ])
plt.show(block=True)

plt.figure(2)
plt.title('Xg.x vs Xg.z')
plt.plot(plot_vals[:,1],plot_vals[:,3],'-')
plt.axis([ np.min(plot_vals[:,1]), np.max(plot_vals[:,1]), np.min(plot_vals[:,3]), np.max(plot_vals[:,3]) ])
plt.show(block=True)
