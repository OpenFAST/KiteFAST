 ...
 ! buffers to store subtypes, if any
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      DO i3 = LBOUND(InData%PtfmDCM,3), UBOUND(InData%PtfmDCM,3)
        DO i2 = LBOUND(InData%PtfmDCM,2), UBOUND(InData%PtfmDCM,2)
          DO i1 = LBOUND(InData%PtfmDCM,1), UBOUND(InData%PtfmDCM,1)
            ReKiBuf(Re_Xferred) = InData%PtfmDCM(i1,i2,i3)
            Re_Xferred = Re_Xferred + 1
          END DO
        END DO
      END DO
 ...
 ! buffers to store meshes, if any
  ...
  ELSE
    ...
    IF (ErrStat2 /= 0) THEN 
       ...
       RETURN
    END IF
      DO i3 = LBOUND(OutData%PtfmDCM,3), UBOUND(OutData%PtfmDCM,3)
        DO i2 = LBOUND(OutData%PtfmDCM,2), UBOUND(OutData%PtfmDCM,2)
          DO i1 = LBOUND(OutData%PtfmDCM,1), UBOUND(OutData%PtfmDCM,1)
            OutData%PtfmDCM(i1,i2,i3) = ReKiBuf(Re_Xferred)
            Re_Xferred = Re_Xferred + 1
          END DO
        END DO
      END DO
...
ENDIF
 ...
 ! buffers to store subtypes, if any
  ...
  Int_Xferred = 1
    ...
    Int_Xferred = Int_Xferred + 1
    IntKiBuf(Int_Xferred) = InData%BodyId
    Int_Xferred = Int_Xferred + 1
 ...
 ! buffers to store subtypes, if any
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      DO i2 = LBOUND(InData%Anchs,2), UBOUND(InData%Anchs,2)
        DO i1 = LBOUND(InData%Anchs,1), UBOUND(InData%Anchs,1)
          ReKiBuf(Re_Xferred) = InData%Anchs(i1,i2)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
 ...
 ! buffers to store meshes, if any
  ...
  ELSE
    ...
    IF (ErrStat2 /= 0) THEN 
       ...
       RETURN
    END IF
      DO i2 = LBOUND(OutData%Anchs,2), UBOUND(OutData%Anchs,2)
        DO i1 = LBOUND(OutData%Anchs,1), UBOUND(OutData%Anchs,1)
          OutData%Anchs(i1,i2) = ReKiBuf(Re_Xferred)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
