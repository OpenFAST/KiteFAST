...
ENDIF
 ...
 ! buffers to store subtypes, if any
  ...
  Int_Xferred = 1
      ...
      IntKiBuf ( Int_Xferred:Int_Xferred+(1)-1 ) = InData%numRtSpd
      Int_Xferred   = Int_Xferred   + 1
      IntKiBuf ( Int_Xferred:Int_Xferred+(1)-1 ) = InData%numSkew
      Int_Xferred   = Int_Xferred   + 1
      IntKiBuf ( Int_Xferred:Int_Xferred+(1)-1 ) = InData%numPitch
      Int_Xferred   = Int_Xferred   + 1
      IntKiBuf ( Int_Xferred:Int_Xferred+(1)-1 ) = InData%numVrel
      Int_Xferred   = Int_Xferred   + 1
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      IF (SIZE(InData%RtSpds)>0) ReKiBuf ( Re_Xferred:Re_Xferred+(SIZE(InData%RtSpds))-1 ) = PACK(InData%RtSpds,.TRUE.)
      Re_Xferred   = Re_Xferred   + SIZE(InData%RtSpds)
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      IF (SIZE(InData%Skews)>0) ReKiBuf ( Re_Xferred:Re_Xferred+(SIZE(InData%Skews))-1 ) = PACK(InData%Skews,.TRUE.)
      Re_Xferred   = Re_Xferred   + SIZE(InData%Skews)
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      IF (SIZE(InData%Pitches)>0) ReKiBuf ( Re_Xferred:Re_Xferred+(SIZE(InData%Pitches))-1 ) = PACK(InData%Pitches,.TRUE.)
      Re_Xferred   = Re_Xferred   + SIZE(InData%Pitches)
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      IF (SIZE(InData%Vrels)>0) ReKiBuf ( Re_Xferred:Re_Xferred+(SIZE(InData%Vrels))-1 ) = PACK(InData%Vrels,.TRUE.)
      Re_Xferred   = Re_Xferred   + SIZE(InData%Vrels)
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      IF (SIZE(InData%RtSpd_Ptch_Vrel_Skw_Table)>0) ReKiBuf ( Re_Xferred:Re_Xferred+(SIZE(InData%RtSpd_Ptch_Vrel_Skw_Table))-1 ) = PACK(InData%RtSpd_Ptch_Vrel_Skw_Table,.TRUE.)
      Re_Xferred   = Re_Xferred   + SIZE(InData%RtSpd_Ptch_Vrel_Skw_Table)
  END IF
 ...
 ! buffers to store meshes, if any
  ...
  ELSE
    ...
    END IF
    mask1 = .TRUE. 
      IF (SIZE(OutData%RtSpds)>0) OutData%RtSpds = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%RtSpds))-1 ), mask1, 0.0_ReKi )
      Re_Xferred   = Re_Xferred   + SIZE(OutData%RtSpds)
    DEALLOCATE(mask1)
  END IF
  ...
  ELSE
    ...
    END IF
    mask1 = .TRUE. 
      IF (SIZE(OutData%Skews)>0) OutData%Skews = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%Skews))-1 ), mask1, 0.0_ReKi )
      Re_Xferred   = Re_Xferred   + SIZE(OutData%Skews)
    DEALLOCATE(mask1)
  END IF
  ...
  ELSE
    ...
    END IF
    mask1 = .TRUE. 
      IF (SIZE(OutData%Pitches)>0) OutData%Pitches = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%Pitches))-1 ), mask1, 0.0_ReKi )
      Re_Xferred   = Re_Xferred   + SIZE(OutData%Pitches)
    DEALLOCATE(mask1)
  END IF
  ...
  ELSE
    ...
    END IF
    mask1 = .TRUE. 
      IF (SIZE(OutData%Vrels)>0) OutData%Vrels = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%Vrels))-1 ), mask1, 0.0_ReKi )
      Re_Xferred   = Re_Xferred   + SIZE(OutData%Vrels)
    DEALLOCATE(mask1)
  END IF
  ...
  ELSE
    ...
    END IF
    mask5 = .TRUE. 
      IF (SIZE(OutData%RtSpd_Ptch_Vrel_Skw_Table)>0) OutData%RtSpd_Ptch_Vrel_Skw_Table = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%RtSpd_Ptch_Vrel_Skw_Table))-1 ), mask5, 0.0_ReKi )
      Re_Xferred   = Re_Xferred   + SIZE(OutData%RtSpd_Ptch_Vrel_Skw_Table)
    DEALLOCATE(mask5)
  END IF
...
! 
 ...
 ! buffers to store subtypes, if any
  ...
  Int_Xferred = 1
      ...
      Re_Xferred   = Re_Xferred   + 1
      ReKiBuf ( Re_Xferred:Re_Xferred+(1)-1 ) = InData%Ct
      Re_Xferred   = Re_Xferred   + 1
      ReKiBuf ( Re_Xferred:Re_Xferred+(1)-1 ) = InData%Cq
      Re_Xferred   = Re_Xferred   + 1
...
ENDIF
 ...
 ! buffers to store subtypes, if any
  ...
  Int_Xferred = 1
      ...
      IntKiBuf ( Int_Xferred:Int_Xferred+(1)-1 ) = InData%RotorMod
      Int_Xferred   = Int_Xferred   + 1
      ReKiBuf ( Re_Xferred:Re_Xferred+(1)-1 ) = InData%RhoD4
      Re_Xferred   = Re_Xferred   + 1
      IntKiBuf ( Int_Xferred:Int_Xferred+(1)-1 ) = InData%numRtSpd
      Int_Xferred   = Int_Xferred   + 1
      IntKiBuf ( Int_Xferred:Int_Xferred+(1)-1 ) = InData%numSkew
...
! 
 ...
 ! buffers to store subtypes, if any
  ...
  Int_Xferred = 1
      ...
      ReKiBuf ( Re_Xferred:Re_Xferred+(1)-1 ) = InData%RtSpd
      Re_Xferred   = Re_Xferred   + 1
      ReKiBuf ( Re_Xferred:Re_Xferred+(1)-1 ) = InData%DiskAve_Vrel
      Re_Xferred   = Re_Xferred   + 1
      ReKiBuf ( Re_Xferred:Re_Xferred+(1)-1 ) = InData%skew
      Re_Xferred   = Re_Xferred   + 1
...
! 
 ...
 ! buffers to store subtypes, if any
  ...
  Int_Xferred = 1
      ...
      ReKiBuf ( Re_Xferred:Re_Xferred+(1)-1 ) = InData%Fx
      Re_Xferred   = Re_Xferred   + 1
      ReKiBuf ( Re_Xferred:Re_Xferred+(1)-1 ) = InData%Fy
      Re_Xferred   = Re_Xferred   + 1
      ReKiBuf ( Re_Xferred:Re_Xferred+(1)-1 ) = InData%Fz
      Re_Xferred   = Re_Xferred   + 1
      ReKiBuf ( Re_Xferred:Re_Xferred+(1)-1 ) = InData%Mx
      Re_Xferred   = Re_Xferred   + 1
      ReKiBuf ( Re_Xferred:Re_Xferred+(1)-1 ) = InData%My
      Re_Xferred   = Re_Xferred   + 1
      ReKiBuf ( Re_Xferred:Re_Xferred+(1)-1 ) = InData%Mz
      Re_Xferred   = Re_Xferred   + 1
      ReKiBuf ( Re_Xferred:Re_Xferred+(1)-1 ) = InData%P
      Re_Xferred   = Re_Xferred   + 1
 ...
 SUBROUTINE ActDsk_Input_ExtrapInterp(u, t, u_out, t_out, ErrStat, ErrMsg )
!
...
!..................................................................................................................................
 ...
 TYPE(ActDsk_InputType), INTENT(IN)  :: u(:) ! Input at t1 > t2 > t3
 REAL(DbKi),                 INTENT(IN   )  :: t(:)           ! Times associated with the Inputs
 TYPE(ActDsk_InputType), INTENT(INOUT)  :: u_out ! Input at tin_out
 ...
 CHARACTER(*),    PARAMETER                 :: RoutineName = 'ActDsk_Input_ExtrapInterp'
    ! Initialize ErrStat
 ErrStat = ErrID_None
 ErrMsg  = ""
 ...
 order = SIZE(u) - 1
 IF ( order .eq. 0 ) THEN
   CALL ActDsk_CopyInput(u(1), u_out, MESH_UPDATECOPY, ErrStat2, ErrMsg2 )
     CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
 ELSE IF ( order .eq. 1 ) THEN
   CALL ActDsk_Input_ExtrapInterp1(u(1), u(2), t, u_out, t_out, ErrStat2, ErrMsg2 )
     CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
 ELSE IF ( order .eq. 2 ) THEN
   CALL ActDsk_Input_ExtrapInterp2(u(1), u(2), u(3), t, u_out, t_out, ErrStat2, ErrMsg2 )
     CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
 ELSE 
   CALL SetErrStat(ErrID_Fatal,'size(u) must be less than 4 (order must be less than 3).',ErrStat,ErrMsg,RoutineName)
   RETURN
 ENDIF 
 END SUBROUTINE ActDsk_Input_ExtrapInterp


 SUBROUTINE ActDsk_Input_ExtrapInterp1(u1, u2, tin, u_out, tin_out, ErrStat, ErrMsg )
!
! This subroutine calculates a extrapolated (or interpolated) Input u_out at time t_out, from previous/future time
...
!..................................................................................................................................
 ...
 TYPE(ActDsk_InputType), INTENT(IN)  :: u1    ! Input at t1 > t2
 TYPE(ActDsk_InputType), INTENT(IN)  :: u2    ! Input at t2 
 ...
 CHARACTER(*),                    PARAMETER :: RoutineName = 'ActDsk_Input_ExtrapInterp1'
 ...
 t_out = tin_out - tin(1)
   ...
   IF ( EqualRealNos( t(1), t(2) ) ) THEN
     ...
     RETURN
   END IF
  b0 = -(u1%RtSpd - u2%RtSpd)/t(2)
  u_out%RtSpd = u1%RtSpd + b0 * t_out
  b0 = -(u1%DiskAve_Vrel - u2%DiskAve_Vrel)/t(2)
  u_out%DiskAve_Vrel = u1%DiskAve_Vrel + b0 * t_out
  b0 = -(u1%skew - u2%skew)/t(2)
  u_out%skew = u1%skew + b0 * t_out
  b0 = -(u1%pitch - u2%pitch)/t(2)
  u_out%pitch = u1%pitch + b0 * t_out
 END SUBROUTINE ActDsk_Input_ExtrapInterp1


 SUBROUTINE ActDsk_Input_ExtrapInterp2(u1, u2, u3, tin, u_out, tin_out, ErrStat, ErrMsg )
!
! This subroutine calculates a extrapolated (or interpolated) Input u_out at time t_out, from previous/future time
...
!..................................................................................................................................
 ...
 TYPE(ActDsk_InputType), INTENT(IN)  :: u1      ! Input at t1 > t2 > t3
 TYPE(ActDsk_InputType), INTENT(IN)  :: u2      ! Input at t2 > t3
 TYPE(ActDsk_InputType), INTENT(IN)  :: u3      ! Input at t3
 ...
 INTEGER(IntKi)                             :: ErrStat2 ! local errors
 CHARACTER(ErrMsgLen)                       :: ErrMsg2  ! local errors
 CHARACTER(*),            PARAMETER         :: RoutineName = 'ActDsk_Input_ExtrapInterp2'
    ! Initialize ErrStat
 ErrStat = ErrID_None
 ErrMsg  = ""
    ! we'll subtract a constant from the times to resolve some 
 ...
 t_out = tin_out - tin(1)
   ...
   ELSE IF ( EqualRealNos( t(1), t(3) ) ) THEN
     ...
     RETURN
   END IF
  b0 = (t(3)**2*(u1%RtSpd - u2%RtSpd) + t(2)**2*(-u1%RtSpd + u3%RtSpd))/(t(2)*t(3)*(t(2) - t(3)))
  c0 = ( (t(2)-t(3))*u1%RtSpd + t(3)*u2%RtSpd - t(2)*u3%RtSpd ) / (t(2)*t(3)*(t(2) - t(3)))
  u_out%RtSpd = u1%RtSpd + b0 * t_out + c0 * t_out**2
  b0 = (t(3)**2*(u1%DiskAve_Vrel - u2%DiskAve_Vrel) + t(2)**2*(-u1%DiskAve_Vrel + u3%DiskAve_Vrel))/(t(2)*t(3)*(t(2) - t(3)))
  c0 = ( (t(2)-t(3))*u1%DiskAve_Vrel + t(3)*u2%DiskAve_Vrel - t(2)*u3%DiskAve_Vrel ) / (t(2)*t(3)*(t(2) - t(3)))
  u_out%DiskAve_Vrel = u1%DiskAve_Vrel + b0 * t_out + c0 * t_out**2
  b0 = (t(3)**2*(u1%skew - u2%skew) + t(2)**2*(-u1%skew + u3%skew))/(t(2)*t(3)*(t(2) - t(3)))
  c0 = ( (t(2)-t(3))*u1%skew + t(3)*u2%skew - t(2)*u3%skew ) / (t(2)*t(3)*(t(2) - t(3)))
  u_out%skew = u1%skew + b0 * t_out + c0 * t_out**2
  b0 = (t(3)**2*(u1%pitch - u2%pitch) + t(2)**2*(-u1%pitch + u3%pitch))/(t(2)*t(3)*(t(2) - t(3)))
  c0 = ( (t(2)-t(3))*u1%pitch + t(3)*u2%pitch - t(2)*u3%pitch ) / (t(2)*t(3)*(t(2) - t(3)))
  u_out%pitch = u1%pitch + b0 * t_out + c0 * t_out**2
 END SUBROUTINE ActDsk_Input_ExtrapInterp2


 SUBROUTINE ActDsk_Output_ExtrapInterp(y, t, y_out, t_out, ErrStat, ErrMsg )
!
...
!..................................................................................................................................
 ...
 TYPE(ActDsk_OutputType), INTENT(IN)  :: y(:) ! Output at t1 > t2 > t3
 REAL(DbKi),                 INTENT(IN   )  :: t(:)           ! Times associated with the Outputs
 TYPE(ActDsk_OutputType), INTENT(INOUT)  :: y_out ! Output at tin_out
 REAL(DbKi),                 INTENT(IN   )  :: t_out           ! time to be extrap/interp'd to
 INTEGER(IntKi),             INTENT(  OUT)  :: ErrStat         ! Error status of the operation
 CHARACTER(*),               INTENT(  OUT)  :: ErrMsg          ! Error message if ErrStat /= ErrID_None
   ! local variables
 ...
 INTEGER(IntKi)                             :: ErrStat2        ! local errors
 CHARACTER(ErrMsgLen)                       :: ErrMsg2         ! local errors
 CHARACTER(*),    PARAMETER                 :: RoutineName = 'ActDsk_Output_ExtrapInterp'
    ! Initialize ErrStat
 ErrStat = ErrID_None
 ErrMsg  = ""
 ...
 order = SIZE(y) - 1
 IF ( order .eq. 0 ) THEN
   CALL ActDsk_CopyOutput(y(1), y_out, MESH_UPDATECOPY, ErrStat2, ErrMsg2 )
     CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
 ELSE IF ( order .eq. 1 ) THEN
   CALL ActDsk_Output_ExtrapInterp1(y(1), y(2), t, y_out, t_out, ErrStat2, ErrMsg2 )
     CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
 ELSE IF ( order .eq. 2 ) THEN
   CALL ActDsk_Output_ExtrapInterp2(y(1), y(2), y(3), t, y_out, t_out, ErrStat2, ErrMsg2 )
     CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
 ELSE 
   CALL SetErrStat(ErrID_Fatal,'size(y) must be less than 4 (order must be less than 3).',ErrStat,ErrMsg,RoutineName)
   RETURN
 ENDIF 
 END SUBROUTINE ActDsk_Output_ExtrapInterp


 SUBROUTINE ActDsk_Output_ExtrapInterp1(y1, y2, tin, y_out, tin_out, ErrStat, ErrMsg )
!
! This subroutine calculates a extrapolated (or interpolated) Output y_out at time t_out, from previous/future time
...
!..................................................................................................................................
 ...
 TYPE(ActDsk_OutputType), INTENT(IN)  :: y1    ! Output at t1 > t2
 TYPE(ActDsk_OutputType), INTENT(IN)  :: y2    ! Output at t2 
 ...
 REAL(DbKi)                                 :: t_out    ! Time to which to be extrap/interpd
 CHARACTER(*),                    PARAMETER :: RoutineName = 'ActDsk_Output_ExtrapInterp1'
 REAL(DbKi)                                 :: b0       ! temporary for extrapolation/interpolation
 REAL(DbKi)                                 :: c0       ! temporary for extrapolation/interpolation
 INTEGER(IntKi)                             :: ErrStat2 ! local errors
 CHARACTER(ErrMsgLen)                       :: ErrMsg2  ! local errors
 ...
 t_out = tin_out - tin(1)
   ...
   END IF
  b0 = -(y1%Fx - y2%Fx)/t(2)
  y_out%Fx = y1%Fx + b0 * t_out
  b0 = -(y1%Fy - y2%Fy)/t(2)
  y_out%Fy = y1%Fy + b0 * t_out
  b0 = -(y1%Fz - y2%Fz)/t(2)
  y_out%Fz = y1%Fz + b0 * t_out
  b0 = -(y1%Mx - y2%Mx)/t(2)
  y_out%Mx = y1%Mx + b0 * t_out
  b0 = -(y1%My - y2%My)/t(2)
  y_out%My = y1%My + b0 * t_out
  b0 = -(y1%Mz - y2%Mz)/t(2)
  y_out%Mz = y1%Mz + b0 * t_out
  b0 = -(y1%P - y2%P)/t(2)
  y_out%P = y1%P + b0 * t_out
 END SUBROUTINE ActDsk_Output_ExtrapInterp1


 SUBROUTINE ActDsk_Output_ExtrapInterp2(y1, y2, y3, tin, y_out, tin_out, ErrStat, ErrMsg )
!
! This subroutine calculates a extrapolated (or interpolated) Output y_out at time t_out, from previous/future time
...
!..................................................................................................................................
 ...
 TYPE(ActDsk_OutputType), INTENT(IN)  :: y1      ! Output at t1 > t2 > t3
 TYPE(ActDsk_OutputType), INTENT(IN)  :: y2      ! Output at t2 > t3
 TYPE(ActDsk_OutputType), INTENT(IN)  :: y3      ! Output at t3
 ...
 INTEGER(IntKi)                             :: ErrStat2 ! local errors
 CHARACTER(ErrMsgLen)                       :: ErrMsg2  ! local errors
 CHARACTER(*),            PARAMETER         :: RoutineName = 'ActDsk_Output_ExtrapInterp2'
    ! Initialize ErrStat
 ErrStat = ErrID_None
 ErrMsg  = ""
    ! we'll subtract a constant from the times to resolve some 
 ...
 t_out = tin_out - tin(1)
   ...
   ELSE IF ( EqualRealNos( t(1), t(3) ) ) THEN
     ...
     RETURN
   END IF
  b0 = (t(3)**2*(y1%Fx - y2%Fx) + t(2)**2*(-y1%Fx + y3%Fx))/(t(2)*t(3)*(t(2) - t(3)))
  c0 = ( (t(2)-t(3))*y1%Fx + t(3)*y2%Fx - t(2)*y3%Fx ) / (t(2)*t(3)*(t(2) - t(3)))
  y_out%Fx = y1%Fx + b0 * t_out + c0 * t_out**2
  b0 = (t(3)**2*(y1%Fy - y2%Fy) + t(2)**2*(-y1%Fy + y3%Fy))/(t(2)*t(3)*(t(2) - t(3)))
  c0 = ( (t(2)-t(3))*y1%Fy + t(3)*y2%Fy - t(2)*y3%Fy ) / (t(2)*t(3)*(t(2) - t(3)))
  y_out%Fy = y1%Fy + b0 * t_out + c0 * t_out**2
  b0 = (t(3)**2*(y1%Fz - y2%Fz) + t(2)**2*(-y1%Fz + y3%Fz))/(t(2)*t(3)*(t(2) - t(3)))
  c0 = ( (t(2)-t(3))*y1%Fz + t(3)*y2%Fz - t(2)*y3%Fz ) / (t(2)*t(3)*(t(2) - t(3)))
  y_out%Fz = y1%Fz + b0 * t_out + c0 * t_out**2
  b0 = (t(3)**2*(y1%Mx - y2%Mx) + t(2)**2*(-y1%Mx + y3%Mx))/(t(2)*t(3)*(t(2) - t(3)))
  c0 = ( (t(2)-t(3))*y1%Mx + t(3)*y2%Mx - t(2)*y3%Mx ) / (t(2)*t(3)*(t(2) - t(3)))
  y_out%Mx = y1%Mx + b0 * t_out + c0 * t_out**2
  b0 = (t(3)**2*(y1%My - y2%My) + t(2)**2*(-y1%My + y3%My))/(t(2)*t(3)*(t(2) - t(3)))
  c0 = ( (t(2)-t(3))*y1%My + t(3)*y2%My - t(2)*y3%My ) / (t(2)*t(3)*(t(2) - t(3)))
  y_out%My = y1%My + b0 * t_out + c0 * t_out**2
  b0 = (t(3)**2*(y1%Mz - y2%Mz) + t(2)**2*(-y1%Mz + y3%Mz))/(t(2)*t(3)*(t(2) - t(3)))
  c0 = ( (t(2)-t(3))*y1%Mz + t(3)*y2%Mz - t(2)*y3%Mz ) / (t(2)*t(3)*(t(2) - t(3)))
  y_out%Mz = y1%Mz + b0 * t_out + c0 * t_out**2
  b0 = (t(3)**2*(y1%P - y2%P) + t(2)**2*(-y1%P + y3%P))/(t(2)*t(3)*(t(2) - t(3)))
  c0 = ( (t(2)-t(3))*y1%P + t(3)*y2%P - t(2)*y3%P ) / (t(2)*t(3)*(t(2) - t(3)))
  y_out%P = y1%P + b0 * t_out + c0 * t_out**2
 END SUBROUTINE ActDsk_Output_ExtrapInterp2
