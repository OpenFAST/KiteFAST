...
ENDIF
 ...
 ! buffers to store subtypes, if any
  ...
  Int_Xferred = 1
      ...
      IntKiBuf ( Int_Xferred:Int_Xferred+(1)-1 ) = InData%CtrlPtMod
      Int_Xferred   = Int_Xferred   + 1
      ReKiBuf ( Re_Xferred:Re_Xferred+(1)-1 ) = InData%VSMToler
      Re_Xferred   = Re_Xferred   + 1
      ReKiBuf ( Re_Xferred:Re_Xferred+(1)-1 ) = InData%VSMMaxIter
      Re_Xferred   = Re_Xferred   + 1
      ...
      Int_Xferred   = Int_Xferred   + 1
      IntKiBuf ( Int_Xferred:Int_Xferred+(1)-1 ) = InData%NumVolElem
      Int_Xferred   = Int_Xferred   + 1
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      IF (SIZE(InData%Chords)>0) ReKiBuf ( Re_Xferred:Re_Xferred+(SIZE(InData%Chords))-1 ) = PACK(InData%Chords,.TRUE.)
      Re_Xferred   = Re_Xferred   + SIZE(InData%Chords)
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      IF (SIZE(InData%AFIDs)>0) IntKiBuf ( Int_Xferred:Int_Xferred+(SIZE(InData%AFIDs))-1 ) = PACK(InData%AFIDs,.TRUE.)
      Int_Xferred   = Int_Xferred   + SIZE(InData%AFIDs)
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      IF (SIZE(InData%ElemLens)>0) ReKiBuf ( Re_Xferred:Re_Xferred+(SIZE(InData%ElemLens))-1 ) = PACK(InData%ElemLens,.TRUE.)
      Re_Xferred   = Re_Xferred   + SIZE(InData%ElemLens)
  END IF
      IntKiBuf ( Int_Xferred:Int_Xferred+(1)-1 ) = InData%NumElem
      Int_Xferred   = Int_Xferred   + 1
 ...
 ! buffers to store meshes, if any
  ...
  ELSE
    ...
    END IF
    mask1 = .TRUE. 
      IF (SIZE(OutData%Chords)>0) OutData%Chords = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%Chords))-1 ), mask1, 0.0_ReKi )
      Re_Xferred   = Re_Xferred   + SIZE(OutData%Chords)
    DEALLOCATE(mask1)
  END IF
  ...
  ELSE
    ...
    END IF
    mask1 = .TRUE. 
      IF (SIZE(OutData%AFIDs)>0) OutData%AFIDs = UNPACK( IntKiBuf ( Int_Xferred:Int_Xferred+(SIZE(OutData%AFIDs))-1 ), mask1, 0_IntKi )
      Int_Xferred   = Int_Xferred   + SIZE(OutData%AFIDs)
    DEALLOCATE(mask1)
  END IF
  ...
  ELSE
    ...
    END IF
    mask1 = .TRUE. 
      IF (SIZE(OutData%ElemLens)>0) OutData%ElemLens = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%ElemLens))-1 ), mask1, 0.0_ReKi )
      Re_Xferred   = Re_Xferred   + SIZE(OutData%ElemLens)
    DEALLOCATE(mask1)
  END IF
...
ENDIF
 ...
 ! buffers to store subtypes, if any
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      IF (SIZE(InData%Gammas)>0) ReKiBuf ( Re_Xferred:Re_Xferred+(SIZE(InData%Gammas))-1 ) = PACK(InData%Gammas,.TRUE.)
      Re_Xferred   = Re_Xferred   + SIZE(InData%Gammas)
  END IF
 ...
 ! buffers to store meshes, if any
  ...
  ELSE
    ...
    END IF
    mask1 = .TRUE. 
      IF (SIZE(OutData%Gammas)>0) OutData%Gammas = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%Gammas))-1 ), mask1, 0.0_ReKi )
      Re_Xferred   = Re_Xferred   + SIZE(OutData%Gammas)
    DEALLOCATE(mask1)
  END IF
...
! 
 ...
 ! buffers to store subtypes, if any
  ...
  Int_Xferred = 1
      ...
      IntKiBuf ( Int_Xferred:Int_Xferred+1-1 ) = TRANSFER( InData%NoStates , IntKiBuf(1), 1)
      Int_Xferred   = Int_Xferred   + 1
 ...
 ! buffers to store meshes, if any
  ...
  Db_Xferred  = 1
  Int_Xferred  = 1
      OutData%NoStates = TRANSFER( IntKiBuf( Int_Xferred ), mask0 )
      Int_Xferred   = Int_Xferred + 1
...
ENDIF
 ...
 ! buffers to store subtypes, if any
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      IF (SIZE(InData%PtP)>0) ReKiBuf ( Re_Xferred:Re_Xferred+(SIZE(InData%PtP))-1 ) = PACK(InData%PtP,.TRUE.)
      Re_Xferred   = Re_Xferred   + SIZE(InData%PtP)
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      IF (SIZE(InData%PtC)>0) ReKiBuf ( Re_Xferred:Re_Xferred+(SIZE(InData%PtC))-1 ) = PACK(InData%PtC,.TRUE.)
      Re_Xferred   = Re_Xferred   + SIZE(InData%PtC)
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      IF (SIZE(InData%Phi_v)>0) ReKiBuf ( Re_Xferred:Re_Xferred+(SIZE(InData%Phi_v))-1 ) = PACK(InData%Phi_v,.TRUE.)
      Re_Xferred   = Re_Xferred   + SIZE(InData%Phi_v)
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      IF (SIZE(InData%Phi_AB2D_v)>0) ReKiBuf ( Re_Xferred:Re_Xferred+(SIZE(InData%Phi_AB2D_v))-1 ) = PACK(InData%Phi_AB2D_v,.TRUE.)
      Re_Xferred   = Re_Xferred   + SIZE(InData%Phi_AB2D_v)
  END IF
      IntKiBuf ( Int_Xferred:Int_Xferred+1-1 ) = TRANSFER( InData%NoInflow , IntKiBuf(1), 1)
      Int_Xferred   = Int_Xferred   + 1
 ...
 ! buffers to store meshes, if any
  ...
  ELSE
    ...
    END IF
    mask2 = .TRUE. 
      IF (SIZE(OutData%PtP)>0) OutData%PtP = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%PtP))-1 ), mask2, 0.0_ReKi )
      Re_Xferred   = Re_Xferred   + SIZE(OutData%PtP)
    DEALLOCATE(mask2)
  END IF
  ...
  ELSE
    ...
    END IF
    mask2 = .TRUE. 
      IF (SIZE(OutData%PtC)>0) OutData%PtC = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%PtC))-1 ), mask2, 0.0_ReKi )
      Re_Xferred   = Re_Xferred   + SIZE(OutData%PtC)
    DEALLOCATE(mask2)
  END IF
  ...
  ELSE
    ...
    END IF
    mask3 = .TRUE. 
      IF (SIZE(OutData%Phi_v)>0) OutData%Phi_v = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%Phi_v))-1 ), mask3, 0.0_ReKi )
      Re_Xferred   = Re_Xferred   + SIZE(OutData%Phi_v)
    DEALLOCATE(mask3)
  END IF
  ...
  ELSE
    ...
    END IF
    mask2 = .TRUE. 
      IF (SIZE(OutData%Phi_AB2D_v)>0) OutData%Phi_AB2D_v = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%Phi_AB2D_v))-1 ), mask2, 0.0_ReKi )
      Re_Xferred   = Re_Xferred   + SIZE(OutData%Phi_AB2D_v)
    DEALLOCATE(mask2)
  END IF
      OutData%NoInflow = TRANSFER( IntKiBuf( Int_Xferred ), mask0 )
      Int_Xferred   = Int_Xferred + 1
...
ENDIF
 ...
 ! buffers to store subtypes, if any
  ...
  END IF
      IntKiBuf ( Int_Xferred:Int_Xferred+(1)-1 ) = InData%NumVolElem
      Int_Xferred   = Int_Xferred   + 1
      IntKiBuf ( Int_Xferred:Int_Xferred+(1)-1 ) = InData%NumGammas
      Int_Xferred   = Int_Xferred   + 1
      IntKiBuf ( Int_Xferred:Int_Xferred+(1)-1 ) = InData%NumOuts
      Int_Xferred   = Int_Xferred   + 1
      IntKiBuf ( Int_Xferred:Int_Xferred+(1)-1 ) = InData%OutSwtch
...
ENDIF
 ...
 ! buffers to store subtypes, if any
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      IF (SIZE(InData%PtA)>0) ReKiBuf ( Re_Xferred:Re_Xferred+(SIZE(InData%PtA))-1 ) = PACK(InData%PtA,.TRUE.)
      Re_Xferred   = Re_Xferred   + SIZE(InData%PtA)
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      IF (SIZE(InData%PtB)>0) ReKiBuf ( Re_Xferred:Re_Xferred+(SIZE(InData%PtB))-1 ) = PACK(InData%PtB,.TRUE.)
      Re_Xferred   = Re_Xferred   + SIZE(InData%PtB)
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      IF (SIZE(InData%x_hat)>0) ReKiBuf ( Re_Xferred:Re_Xferred+(SIZE(InData%x_hat))-1 ) = PACK(InData%x_hat,.TRUE.)
      Re_Xferred   = Re_Xferred   + SIZE(InData%x_hat)
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      IF (SIZE(InData%y_hat)>0) ReKiBuf ( Re_Xferred:Re_Xferred+(SIZE(InData%y_hat))-1 ) = PACK(InData%y_hat,.TRUE.)
      Re_Xferred   = Re_Xferred   + SIZE(InData%y_hat)
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      IF (SIZE(InData%z_hat)>0) ReKiBuf ( Re_Xferred:Re_Xferred+(SIZE(InData%z_hat))-1 ) = PACK(InData%z_hat,.TRUE.)
      Re_Xferred   = Re_Xferred   + SIZE(InData%z_hat)
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      IF (SIZE(InData%U_Inf_v)>0) ReKiBuf ( Re_Xferred:Re_Xferred+(SIZE(InData%U_Inf_v))-1 ) = PACK(InData%U_Inf_v,.TRUE.)
      Re_Xferred   = Re_Xferred   + SIZE(InData%U_Inf_v)
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      IF (SIZE(InData%Deltaf)>0) ReKiBuf ( Re_Xferred:Re_Xferred+(SIZE(InData%Deltaf))-1 ) = PACK(InData%Deltaf,.TRUE.)
      Re_Xferred   = Re_Xferred   + SIZE(InData%Deltaf)
  END IF
 ...
 ! buffers to store meshes, if any
  ...
  ELSE
    ...
    END IF
    mask2 = .TRUE. 
      IF (SIZE(OutData%PtA)>0) OutData%PtA = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%PtA))-1 ), mask2, 0.0_ReKi )
      Re_Xferred   = Re_Xferred   + SIZE(OutData%PtA)
    DEALLOCATE(mask2)
  END IF
  ...
  ELSE
    ...
    END IF
    mask2 = .TRUE. 
      IF (SIZE(OutData%PtB)>0) OutData%PtB = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%PtB))-1 ), mask2, 0.0_ReKi )
      Re_Xferred   = Re_Xferred   + SIZE(OutData%PtB)
    DEALLOCATE(mask2)
  END IF
  ...
  ELSE
    ...
    END IF
    mask2 = .TRUE. 
      IF (SIZE(OutData%x_hat)>0) OutData%x_hat = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%x_hat))-1 ), mask2, 0.0_ReKi )
      Re_Xferred   = Re_Xferred   + SIZE(OutData%x_hat)
    DEALLOCATE(mask2)
  END IF
  ...
  ELSE
    ...
    END IF
    mask2 = .TRUE. 
      IF (SIZE(OutData%y_hat)>0) OutData%y_hat = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%y_hat))-1 ), mask2, 0.0_ReKi )
      Re_Xferred   = Re_Xferred   + SIZE(OutData%y_hat)
    DEALLOCATE(mask2)
  END IF
  ...
  ELSE
    ...
    END IF
    mask2 = .TRUE. 
      IF (SIZE(OutData%z_hat)>0) OutData%z_hat = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%z_hat))-1 ), mask2, 0.0_ReKi )
      Re_Xferred   = Re_Xferred   + SIZE(OutData%z_hat)
    DEALLOCATE(mask2)
  END IF
  ...
  ELSE
    ...
    END IF
    mask2 = .TRUE. 
      IF (SIZE(OutData%U_Inf_v)>0) OutData%U_Inf_v = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%U_Inf_v))-1 ), mask2, 0.0_ReKi )
      Re_Xferred   = Re_Xferred   + SIZE(OutData%U_Inf_v)
    DEALLOCATE(mask2)
  END IF
  ...
  ELSE
    ...
    END IF
    mask1 = .TRUE. 
      IF (SIZE(OutData%Deltaf)>0) OutData%Deltaf = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%Deltaf))-1 ), mask1, 0.0_ReKi )
      Re_Xferred   = Re_Xferred   + SIZE(OutData%Deltaf)
    DEALLOCATE(mask1)
  END IF
...
ENDIF
 ...
 ! buffers to store subtypes, if any
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      IF (SIZE(InData%Loads)>0) ReKiBuf ( Re_Xferred:Re_Xferred+(SIZE(InData%Loads))-1 ) = PACK(InData%Loads,.TRUE.)
      Re_Xferred   = Re_Xferred   + SIZE(InData%Loads)
  END IF
 ...
 ! buffers to store meshes, if any
  ...
  ELSE
    ...
    END IF
    mask2 = .TRUE. 
      IF (SIZE(OutData%Loads)>0) OutData%Loads = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%Loads))-1 ), mask2, 0.0_ReKi )
      Re_Xferred   = Re_Xferred   + SIZE(OutData%Loads)
    DEALLOCATE(mask2)
  END IF
  ...
  ELSE
    ...
    END IF
    mask2 = .TRUE. 
      IF (SIZE(OutData%Vind)>0) OutData%Vind = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%Vind))-1 ), mask2, 0.0_ReKi )
  ...
  ELSE
    ...
    END IF
    mask1 = .TRUE. 
      IF (SIZE(OutData%AoA)>0) OutData%AoA = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%AoA))-1 ), mask1, 0.0_ReKi )
  ...
  ELSE
    ...
    END IF
    mask1 = .TRUE. 
      IF (SIZE(OutData%Cl)>0) OutData%Cl = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%Cl))-1 ), mask1, 0.0_ReKi )
  ...
  ELSE
    ...
    END IF
    mask1 = .TRUE. 
      IF (SIZE(OutData%Cm)>0) OutData%Cm = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%Cm))-1 ), mask1, 0.0_ReKi )
 ...
 SUBROUTINE VSM_Input_ExtrapInterp(u, t, u_out, t_out, ErrStat, ErrMsg )
!
...
!..................................................................................................................................
 ...
 TYPE(VSM_InputType), INTENT(IN)  :: u(:) ! Input at t1 > t2 > t3
 REAL(DbKi),                 INTENT(IN   )  :: t(:)           ! Times associated with the Inputs
 TYPE(VSM_InputType), INTENT(INOUT)  :: u_out ! Input at tin_out
 ...
 CHARACTER(*),    PARAMETER                 :: RoutineName = 'VSM_Input_ExtrapInterp'
    ! Initialize ErrStat
 ErrStat = ErrID_None
 ErrMsg  = ""
 ...
 order = SIZE(u) - 1
 IF ( order .eq. 0 ) THEN
   CALL VSM_CopyInput(u(1), u_out, MESH_UPDATECOPY, ErrStat2, ErrMsg2 )
     CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
 ELSE IF ( order .eq. 1 ) THEN
   CALL VSM_Input_ExtrapInterp1(u(1), u(2), t, u_out, t_out, ErrStat2, ErrMsg2 )
     CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
 ELSE IF ( order .eq. 2 ) THEN
   CALL VSM_Input_ExtrapInterp2(u(1), u(2), u(3), t, u_out, t_out, ErrStat2, ErrMsg2 )
     CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
 ELSE 
   CALL SetErrStat(ErrID_Fatal,'size(u) must be less than 4 (order must be less than 3).',ErrStat,ErrMsg,RoutineName)
   RETURN
 ENDIF 
 END SUBROUTINE VSM_Input_ExtrapInterp


 SUBROUTINE VSM_Input_ExtrapInterp1(u1, u2, tin, u_out, tin_out, ErrStat, ErrMsg )
!
! This subroutine calculates a extrapolated (or interpolated) Input u_out at time t_out, from previous/future time
...
!..................................................................................................................................
 ...
 TYPE(VSM_InputType), INTENT(IN)  :: u1    ! Input at t1 > t2
 TYPE(VSM_InputType), INTENT(IN)  :: u2    ! Input at t2 
 ...
 CHARACTER(*),                    PARAMETER :: RoutineName = 'VSM_Input_ExtrapInterp1'
 ...
 t_out = tin_out - tin(1)
   ...
   IF ( EqualRealNos( t(1), t(2) ) ) THEN
     ...
     RETURN
   END IF
IF (ALLOCATED(u_out%PtA) .AND. ALLOCATED(u1%PtA)) THEN
  ALLOCATE(b2(SIZE(u_out%PtA,1),SIZE(u_out%PtA,2) ))
  ALLOCATE(c2(SIZE(u_out%PtA,1),SIZE(u_out%PtA,2) ))
  b2 = -(u1%PtA - u2%PtA)/t(2)
  u_out%PtA = u1%PtA + b2 * t_out
  DEALLOCATE(b2)
  DEALLOCATE(c2)
END IF ! check if allocated
IF (ALLOCATED(u_out%PtB) .AND. ALLOCATED(u1%PtB)) THEN
  ALLOCATE(b2(SIZE(u_out%PtB,1),SIZE(u_out%PtB,2) ))
  ALLOCATE(c2(SIZE(u_out%PtB,1),SIZE(u_out%PtB,2) ))
  b2 = -(u1%PtB - u2%PtB)/t(2)
  u_out%PtB = u1%PtB + b2 * t_out
  DEALLOCATE(b2)
  DEALLOCATE(c2)
END IF ! check if allocated
IF (ALLOCATED(u_out%x_hat) .AND. ALLOCATED(u1%x_hat)) THEN
  ALLOCATE(b2(SIZE(u_out%x_hat,1),SIZE(u_out%x_hat,2) ))
  ALLOCATE(c2(SIZE(u_out%x_hat,1),SIZE(u_out%x_hat,2) ))
  b2 = -(u1%x_hat - u2%x_hat)/t(2)
  u_out%x_hat = u1%x_hat + b2 * t_out
  DEALLOCATE(b2)
  DEALLOCATE(c2)
END IF ! check if allocated
IF (ALLOCATED(u_out%y_hat) .AND. ALLOCATED(u1%y_hat)) THEN
  ALLOCATE(b2(SIZE(u_out%y_hat,1),SIZE(u_out%y_hat,2) ))
  ALLOCATE(c2(SIZE(u_out%y_hat,1),SIZE(u_out%y_hat,2) ))
  b2 = -(u1%y_hat - u2%y_hat)/t(2)
  u_out%y_hat = u1%y_hat + b2 * t_out
  DEALLOCATE(b2)
  DEALLOCATE(c2)
END IF ! check if allocated
IF (ALLOCATED(u_out%z_hat) .AND. ALLOCATED(u1%z_hat)) THEN
  ALLOCATE(b2(SIZE(u_out%z_hat,1),SIZE(u_out%z_hat,2) ))
  ALLOCATE(c2(SIZE(u_out%z_hat,1),SIZE(u_out%z_hat,2) ))
  b2 = -(u1%z_hat - u2%z_hat)/t(2)
  u_out%z_hat = u1%z_hat + b2 * t_out
  DEALLOCATE(b2)
  DEALLOCATE(c2)
END IF ! check if allocated
IF (ALLOCATED(u_out%U_Inf_v) .AND. ALLOCATED(u1%U_Inf_v)) THEN
  ALLOCATE(b2(SIZE(u_out%U_Inf_v,1),SIZE(u_out%U_Inf_v,2) ))
  ALLOCATE(c2(SIZE(u_out%U_Inf_v,1),SIZE(u_out%U_Inf_v,2) ))
  b2 = -(u1%U_Inf_v - u2%U_Inf_v)/t(2)
  u_out%U_Inf_v = u1%U_Inf_v + b2 * t_out
  DEALLOCATE(b2)
  DEALLOCATE(c2)
END IF ! check if allocated
IF (ALLOCATED(u_out%Deltaf) .AND. ALLOCATED(u1%Deltaf)) THEN
  ALLOCATE(b1(SIZE(u_out%Deltaf,1)))
  ALLOCATE(c1(SIZE(u_out%Deltaf,1)))
  b1 = -(u1%Deltaf - u2%Deltaf)/t(2)
  u_out%Deltaf = u1%Deltaf + b1 * t_out
  DEALLOCATE(b1)
  DEALLOCATE(c1)
END IF ! check if allocated
 END SUBROUTINE VSM_Input_ExtrapInterp1


 SUBROUTINE VSM_Input_ExtrapInterp2(u1, u2, u3, tin, u_out, tin_out, ErrStat, ErrMsg )
!
! This subroutine calculates a extrapolated (or interpolated) Input u_out at time t_out, from previous/future time
...
!..................................................................................................................................
 ...
 TYPE(VSM_InputType), INTENT(IN)  :: u1      ! Input at t1 > t2 > t3
 TYPE(VSM_InputType), INTENT(IN)  :: u2      ! Input at t2 > t3
 TYPE(VSM_InputType), INTENT(IN)  :: u3      ! Input at t3
 ...
 INTEGER(IntKi)                             :: ErrStat2 ! local errors
 CHARACTER(ErrMsgLen)                       :: ErrMsg2  ! local errors
 CHARACTER(*),            PARAMETER         :: RoutineName = 'VSM_Input_ExtrapInterp2'
    ! Initialize ErrStat
 ErrStat = ErrID_None
 ErrMsg  = ""
    ! we'll subtract a constant from the times to resolve some 
...
IF (ALLOCATED(u_out%PtA) .AND. ALLOCATED(u1%PtA)) THEN
  ALLOCATE(b2(SIZE(u_out%PtA,1),SIZE(u_out%PtA,2) ))
  ALLOCATE(c2(SIZE(u_out%PtA,1),SIZE(u_out%PtA,2) ))
  b2 = (t(3)**2*(u1%PtA - u2%PtA) + t(2)**2*(-u1%PtA + u3%PtA))/(t(2)*t(3)*(t(2) - t(3)))
  c2 = ( (t(2)-t(3))*u1%PtA + t(3)*u2%PtA - t(2)*u3%PtA ) / (t(2)*t(3)*(t(2) - t(3)))
  u_out%PtA = u1%PtA + b2 * t_out + c2 * t_out**2
  DEALLOCATE(b2)
  DEALLOCATE(c2)
END IF ! check if allocated
IF (ALLOCATED(u_out%PtB) .AND. ALLOCATED(u1%PtB)) THEN
  ALLOCATE(b2(SIZE(u_out%PtB,1),SIZE(u_out%PtB,2) ))
  ALLOCATE(c2(SIZE(u_out%PtB,1),SIZE(u_out%PtB,2) ))
  b2 = (t(3)**2*(u1%PtB - u2%PtB) + t(2)**2*(-u1%PtB + u3%PtB))/(t(2)*t(3)*(t(2) - t(3)))
  c2 = ( (t(2)-t(3))*u1%PtB + t(3)*u2%PtB - t(2)*u3%PtB ) / (t(2)*t(3)*(t(2) - t(3)))
  u_out%PtB = u1%PtB + b2 * t_out + c2 * t_out**2
  DEALLOCATE(b2)
  DEALLOCATE(c2)
END IF ! check if allocated
IF (ALLOCATED(u_out%x_hat) .AND. ALLOCATED(u1%x_hat)) THEN
  ALLOCATE(b2(SIZE(u_out%x_hat,1),SIZE(u_out%x_hat,2) ))
  ALLOCATE(c2(SIZE(u_out%x_hat,1),SIZE(u_out%x_hat,2) ))
  b2 = (t(3)**2*(u1%x_hat - u2%x_hat) + t(2)**2*(-u1%x_hat + u3%x_hat))/(t(2)*t(3)*(t(2) - t(3)))
  c2 = ( (t(2)-t(3))*u1%x_hat + t(3)*u2%x_hat - t(2)*u3%x_hat ) / (t(2)*t(3)*(t(2) - t(3)))
  u_out%x_hat = u1%x_hat + b2 * t_out + c2 * t_out**2
  DEALLOCATE(b2)
  DEALLOCATE(c2)
END IF ! check if allocated
IF (ALLOCATED(u_out%y_hat) .AND. ALLOCATED(u1%y_hat)) THEN
  ALLOCATE(b2(SIZE(u_out%y_hat,1),SIZE(u_out%y_hat,2) ))
  ALLOCATE(c2(SIZE(u_out%y_hat,1),SIZE(u_out%y_hat,2) ))
  b2 = (t(3)**2*(u1%y_hat - u2%y_hat) + t(2)**2*(-u1%y_hat + u3%y_hat))/(t(2)*t(3)*(t(2) - t(3)))
  c2 = ( (t(2)-t(3))*u1%y_hat + t(3)*u2%y_hat - t(2)*u3%y_hat ) / (t(2)*t(3)*(t(2) - t(3)))
  u_out%y_hat = u1%y_hat + b2 * t_out + c2 * t_out**2
  DEALLOCATE(b2)
  DEALLOCATE(c2)
END IF ! check if allocated
IF (ALLOCATED(u_out%z_hat) .AND. ALLOCATED(u1%z_hat)) THEN
  ALLOCATE(b2(SIZE(u_out%z_hat,1),SIZE(u_out%z_hat,2) ))
  ALLOCATE(c2(SIZE(u_out%z_hat,1),SIZE(u_out%z_hat,2) ))
  b2 = (t(3)**2*(u1%z_hat - u2%z_hat) + t(2)**2*(-u1%z_hat + u3%z_hat))/(t(2)*t(3)*(t(2) - t(3)))
  c2 = ( (t(2)-t(3))*u1%z_hat + t(3)*u2%z_hat - t(2)*u3%z_hat ) / (t(2)*t(3)*(t(2) - t(3)))
  u_out%z_hat = u1%z_hat + b2 * t_out + c2 * t_out**2
  DEALLOCATE(b2)
  DEALLOCATE(c2)
END IF ! check if allocated
IF (ALLOCATED(u_out%U_Inf_v) .AND. ALLOCATED(u1%U_Inf_v)) THEN
  ALLOCATE(b2(SIZE(u_out%U_Inf_v,1),SIZE(u_out%U_Inf_v,2) ))
  ALLOCATE(c2(SIZE(u_out%U_Inf_v,1),SIZE(u_out%U_Inf_v,2) ))
  b2 = (t(3)**2*(u1%U_Inf_v - u2%U_Inf_v) + t(2)**2*(-u1%U_Inf_v + u3%U_Inf_v))/(t(2)*t(3)*(t(2) - t(3)))
  c2 = ( (t(2)-t(3))*u1%U_Inf_v + t(3)*u2%U_Inf_v - t(2)*u3%U_Inf_v ) / (t(2)*t(3)*(t(2) - t(3)))
  u_out%U_Inf_v = u1%U_Inf_v + b2 * t_out + c2 * t_out**2
  DEALLOCATE(b2)
  DEALLOCATE(c2)
END IF ! check if allocated
IF (ALLOCATED(u_out%Deltaf) .AND. ALLOCATED(u1%Deltaf)) THEN
  ALLOCATE(b1(SIZE(u_out%Deltaf,1)))
  ALLOCATE(c1(SIZE(u_out%Deltaf,1)))
  b1 = (t(3)**2*(u1%Deltaf - u2%Deltaf) + t(2)**2*(-u1%Deltaf + u3%Deltaf))/(t(2)*t(3)*(t(2) - t(3)))
  c1 = ( (t(2)-t(3))*u1%Deltaf + t(3)*u2%Deltaf - t(2)*u3%Deltaf ) / (t(2)*t(3)*(t(2) - t(3)))
  u_out%Deltaf = u1%Deltaf + b1 * t_out + c1 * t_out**2
  DEALLOCATE(b1)
  DEALLOCATE(c1)
END IF ! check if allocated
 END SUBROUTINE VSM_Input_ExtrapInterp2


 SUBROUTINE VSM_Output_ExtrapInterp(y, t, y_out, t_out, ErrStat, ErrMsg )
!
...
!..................................................................................................................................
 ...
 TYPE(VSM_OutputType), INTENT(IN)  :: y(:) ! Output at t1 > t2 > t3
 REAL(DbKi),                 INTENT(IN   )  :: t(:)           ! Times associated with the Outputs
 TYPE(VSM_OutputType), INTENT(INOUT)  :: y_out ! Output at tin_out
 REAL(DbKi),                 INTENT(IN   )  :: t_out           ! time to be extrap/interp'd to
 INTEGER(IntKi),             INTENT(  OUT)  :: ErrStat         ! Error status of the operation
 CHARACTER(*),               INTENT(  OUT)  :: ErrMsg          ! Error message if ErrStat /= ErrID_None
   ! local variables
 ...
 INTEGER(IntKi)                             :: ErrStat2        ! local errors
 CHARACTER(ErrMsgLen)                       :: ErrMsg2         ! local errors
 CHARACTER(*),    PARAMETER                 :: RoutineName = 'VSM_Output_ExtrapInterp'
    ! Initialize ErrStat
 ErrStat = ErrID_None
 ErrMsg  = ""
 ...
 order = SIZE(y) - 1
 IF ( order .eq. 0 ) THEN
   CALL VSM_CopyOutput(y(1), y_out, MESH_UPDATECOPY, ErrStat2, ErrMsg2 )
     CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
 ELSE IF ( order .eq. 1 ) THEN
   CALL VSM_Output_ExtrapInterp1(y(1), y(2), t, y_out, t_out, ErrStat2, ErrMsg2 )
     CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
 ELSE IF ( order .eq. 2 ) THEN
   CALL VSM_Output_ExtrapInterp2(y(1), y(2), y(3), t, y_out, t_out, ErrStat2, ErrMsg2 )
     CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
 ELSE 
   CALL SetErrStat(ErrID_Fatal,'size(y) must be less than 4 (order must be less than 3).',ErrStat,ErrMsg,RoutineName)
   RETURN
 ENDIF 
 END SUBROUTINE VSM_Output_ExtrapInterp


 SUBROUTINE VSM_Output_ExtrapInterp1(y1, y2, tin, y_out, tin_out, ErrStat, ErrMsg )
!
! This subroutine calculates a extrapolated (or interpolated) Output y_out at time t_out, from previous/future time
...
!..................................................................................................................................
 ...
 TYPE(VSM_OutputType), INTENT(IN)  :: y1    ! Output at t1 > t2
 TYPE(VSM_OutputType), INTENT(IN)  :: y2    ! Output at t2 
 ...
 REAL(DbKi)                                 :: t_out    ! Time to which to be extrap/interpd
 CHARACTER(*),                    PARAMETER :: RoutineName = 'VSM_Output_ExtrapInterp1'
 REAL(DbKi)                                 :: b0       ! temporary for extrapolation/interpolation
 REAL(DbKi)                                 :: c0       ! temporary for extrapolation/interpolation
 REAL(DbKi),ALLOCATABLE,DIMENSION(:)        :: b1       ! temporary for extrapolation/interpolation
 REAL(DbKi),ALLOCATABLE,DIMENSION(:)        :: c1       ! temporary for extrapolation/interpolation
 ...
 t_out = tin_out - tin(1)
   ...
   IF ( EqualRealNos( t(1), t(2) ) ) THEN
     ...
     RETURN
   END IF
IF (ALLOCATED(y_out%Loads) .AND. ALLOCATED(y1%Loads)) THEN
  ALLOCATE(b2(SIZE(y_out%Loads,1),SIZE(y_out%Loads,2) ))
  ALLOCATE(c2(SIZE(y_out%Loads,1),SIZE(y_out%Loads,2) ))
  b2 = -(y1%Loads - y2%Loads)/t(2)
  y_out%Loads = y1%Loads + b2 * t_out
  DEALLOCATE(b2)
  DEALLOCATE(c2)
END IF ! check if allocated
IF (ALLOCATED(y_out%Vind) .AND. ALLOCATED(y1%Vind)) THEN
  ALLOCATE(b2(SIZE(y_out%Vind,1),SIZE(y_out%Vind,2) ))
  ALLOCATE(c2(SIZE(y_out%Vind,1),SIZE(y_out%Vind,2) ))
  b2 = -(y1%Vind - y2%Vind)/t(2)
  y_out%Vind = y1%Vind + b2 * t_out
  DEALLOCATE(b2)
  DEALLOCATE(c2)
END IF ! check if allocated
IF (ALLOCATED(y_out%AoA) .AND. ALLOCATED(y1%AoA)) THEN
  ALLOCATE(b1(SIZE(y_out%AoA,1)))
  ALLOCATE(c1(SIZE(y_out%AoA,1)))
  b1 = -(y1%AoA - y2%AoA)/t(2)
  y_out%AoA = y1%AoA + b1 * t_out
  DEALLOCATE(b1)
  DEALLOCATE(c1)
END IF ! check if allocated
IF (ALLOCATED(y_out%Cl) .AND. ALLOCATED(y1%Cl)) THEN
  ALLOCATE(b1(SIZE(y_out%Cl,1)))
  ALLOCATE(c1(SIZE(y_out%Cl,1)))
  b1 = -(y1%Cl - y2%Cl)/t(2)
  y_out%Cl = y1%Cl + b1 * t_out
  DEALLOCATE(b1)
  DEALLOCATE(c1)
END IF ! check if allocated
IF (ALLOCATED(y_out%Cd) .AND. ALLOCATED(y1%Cd)) THEN
  ALLOCATE(b1(SIZE(y_out%Cd,1)))
  ALLOCATE(c1(SIZE(y_out%Cd,1)))
  b1 = -(y1%Cd - y2%Cd)/t(2)
  y_out%Cd = y1%Cd + b1 * t_out
  DEALLOCATE(b1)
  DEALLOCATE(c1)
END IF ! check if allocated
IF (ALLOCATED(y_out%Cm) .AND. ALLOCATED(y1%Cm)) THEN
  ALLOCATE(b1(SIZE(y_out%Cm,1)))
  ALLOCATE(c1(SIZE(y_out%Cm,1)))
  b1 = -(y1%Cm - y2%Cm)/t(2)
  y_out%Cm = y1%Cm + b1 * t_out
  DEALLOCATE(b1)
  DEALLOCATE(c1)
END IF ! check if allocated
IF (ALLOCATED(y_out%WriteOutput) .AND. ALLOCATED(y1%WriteOutput)) THEN
  ...
  DEALLOCATE(c1)
END IF ! check if allocated
 END SUBROUTINE VSM_Output_ExtrapInterp1


 SUBROUTINE VSM_Output_ExtrapInterp2(y1, y2, y3, tin, y_out, tin_out, ErrStat, ErrMsg )
!
! This subroutine calculates a extrapolated (or interpolated) Output y_out at time t_out, from previous/future time
...
!..................................................................................................................................
 ...
 TYPE(VSM_OutputType), INTENT(IN)  :: y1      ! Output at t1 > t2 > t3
 TYPE(VSM_OutputType), INTENT(IN)  :: y2      ! Output at t2 > t3
 TYPE(VSM_OutputType), INTENT(IN)  :: y3      ! Output at t3
 ...
 INTEGER(IntKi)                             :: ErrStat2 ! local errors
 CHARACTER(ErrMsgLen)                       :: ErrMsg2  ! local errors
 CHARACTER(*),            PARAMETER         :: RoutineName = 'VSM_Output_ExtrapInterp2'
    ! Initialize ErrStat
 ErrStat = ErrID_None
 ErrMsg  = ""
    ! we'll subtract a constant from the times to resolve some 
...
IF (ALLOCATED(y_out%Loads) .AND. ALLOCATED(y1%Loads)) THEN
  ALLOCATE(b2(SIZE(y_out%Loads,1),SIZE(y_out%Loads,2) ))
  ALLOCATE(c2(SIZE(y_out%Loads,1),SIZE(y_out%Loads,2) ))
  b2 = (t(3)**2*(y1%Loads - y2%Loads) + t(2)**2*(-y1%Loads + y3%Loads))/(t(2)*t(3)*(t(2) - t(3)))
  c2 = ( (t(2)-t(3))*y1%Loads + t(3)*y2%Loads - t(2)*y3%Loads ) / (t(2)*t(3)*(t(2) - t(3)))
  y_out%Loads = y1%Loads + b2 * t_out + c2 * t_out**2
  DEALLOCATE(b2)
  DEALLOCATE(c2)
END IF ! check if allocated
IF (ALLOCATED(y_out%Vind) .AND. ALLOCATED(y1%Vind)) THEN
  ALLOCATE(b2(SIZE(y_out%Vind,1),SIZE(y_out%Vind,2) ))
  ALLOCATE(c2(SIZE(y_out%Vind,1),SIZE(y_out%Vind,2) ))
  b2 = (t(3)**2*(y1%Vind - y2%Vind) + t(2)**2*(-y1%Vind + y3%Vind))/(t(2)*t(3)*(t(2) - t(3)))
  c2 = ( (t(2)-t(3))*y1%Vind + t(3)*y2%Vind - t(2)*y3%Vind ) / (t(2)*t(3)*(t(2) - t(3)))
  y_out%Vind = y1%Vind + b2 * t_out + c2 * t_out**2
  DEALLOCATE(b2)
  DEALLOCATE(c2)
END IF ! check if allocated
IF (ALLOCATED(y_out%AoA) .AND. ALLOCATED(y1%AoA)) THEN
  ALLOCATE(b1(SIZE(y_out%AoA,1)))
  ALLOCATE(c1(SIZE(y_out%AoA,1)))
  b1 = (t(3)**2*(y1%AoA - y2%AoA) + t(2)**2*(-y1%AoA + y3%AoA))/(t(2)*t(3)*(t(2) - t(3)))
  c1 = ( (t(2)-t(3))*y1%AoA + t(3)*y2%AoA - t(2)*y3%AoA ) / (t(2)*t(3)*(t(2) - t(3)))
  y_out%AoA = y1%AoA + b1 * t_out + c1 * t_out**2
  DEALLOCATE(b1)
  DEALLOCATE(c1)
END IF ! check if allocated
IF (ALLOCATED(y_out%Cl) .AND. ALLOCATED(y1%Cl)) THEN
  ALLOCATE(b1(SIZE(y_out%Cl,1)))
  ALLOCATE(c1(SIZE(y_out%Cl,1)))
  b1 = (t(3)**2*(y1%Cl - y2%Cl) + t(2)**2*(-y1%Cl + y3%Cl))/(t(2)*t(3)*(t(2) - t(3)))
  c1 = ( (t(2)-t(3))*y1%Cl + t(3)*y2%Cl - t(2)*y3%Cl ) / (t(2)*t(3)*(t(2) - t(3)))
  y_out%Cl = y1%Cl + b1 * t_out + c1 * t_out**2
  DEALLOCATE(b1)
  DEALLOCATE(c1)
END IF ! check if allocated
IF (ALLOCATED(y_out%Cd) .AND. ALLOCATED(y1%Cd)) THEN
  ALLOCATE(b1(SIZE(y_out%Cd,1)))
  ALLOCATE(c1(SIZE(y_out%Cd,1)))
  b1 = (t(3)**2*(y1%Cd - y2%Cd) + t(2)**2*(-y1%Cd + y3%Cd))/(t(2)*t(3)*(t(2) - t(3)))
  c1 = ( (t(2)-t(3))*y1%Cd + t(3)*y2%Cd - t(2)*y3%Cd ) / (t(2)*t(3)*(t(2) - t(3)))
  y_out%Cd = y1%Cd + b1 * t_out + c1 * t_out**2
  DEALLOCATE(b1)
  DEALLOCATE(c1)
END IF ! check if allocated
IF (ALLOCATED(y_out%Cm) .AND. ALLOCATED(y1%Cm)) THEN
  ALLOCATE(b1(SIZE(y_out%Cm,1)))
  ALLOCATE(c1(SIZE(y_out%Cm,1)))
  b1 = (t(3)**2*(y1%Cm - y2%Cm) + t(2)**2*(-y1%Cm + y3%Cm))/(t(2)*t(3)*(t(2) - t(3)))
  c1 = ( (t(2)-t(3))*y1%Cm + t(3)*y2%Cm - t(2)*y3%Cm ) / (t(2)*t(3)*(t(2) - t(3)))
  y_out%Cm = y1%Cm + b1 * t_out + c1 * t_out**2
  DEALLOCATE(b1)
  DEALLOCATE(c1)
END IF ! check if allocated
IF (ALLOCATED(y_out%WriteOutput) .AND. ALLOCATED(y1%WriteOutput)) THEN
  ...
  DEALLOCATE(c1)
END IF ! check if allocated
 END SUBROUTINE VSM_Output_ExtrapInterp2
