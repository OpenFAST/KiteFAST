...
class MainSet():
    ...
    def export_set_file(self, output_directory):
        ...
        output.write_line("set: integer {}_body_count = {};".format(self.starboard_horizontal_stabilizer.component_name, self.starboard_horizontal_stabilizer.body_count))
        ...
        output.write_line("set: integer {}_body_count = {};".format(self.port_horizontal_stabilizer.component_name, self.port_horizontal_stabilizer.body_count))
        ...
        output.write_line("set: integer {}_body_count = {};".format(self.vertical_stabilizer.component_name, self.vertical_stabilizer.body_count))
